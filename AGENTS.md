...
CONTEXT (IMPORTANT): the 'blueprints' folder is the source of truth for the app. It contains the most up to date information about the app. Use these documents to set your goals and scope.
